...
export default function DecoyVaultSetupModal ({ isOpen, onClose, theme }) {
  ...
  return (
    <div className="dash-mobile-bottom-sheet fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div style={{ animation: 'dash-modal-in 150ms ease-out forwards' }} className={`transform relative w-full max-w-md rounded-2xl p-6 max-h-[80vh] overflow-y-auto ${containerClass}`}>
        {/* Header */}
