...
export default function TagModal({ isOpen, onClose, onConfirm, onDelete, tag, existingTags, deleteTagFromAllPages, pages = [] }) {
  ...
  return (
    <div className="dash-mobile-bottom-sheet fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black bg-opacity-50 p-4" onClick={handleOverlayClick} style={{ animation: 'dash-backdrop-in 150ms ease-out forwards' }}>
