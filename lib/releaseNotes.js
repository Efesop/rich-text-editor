export const releaseNotes = [
  {
    ...
    features: [
      ...
      {
        icon: 'Languages',
        title: 'PDFs in every language',
        description: 'PDF export keeps Chinese, Japanese, Korean, Arabic, Hebrew, Greek and Cyrillic text and your emoji, with right-to-left lines aligned right. The fonts it needs load only when a note uses them.'
      },
      {
        icon: 'FileInput',
