export const releaseNotes = [
  ...
  },
  {
    icon: 'Focus',
    title: 'Focus Mode',
    description: 'Distraction-free writing with typewriter scrolling, paragraph dimming, and session stats. Toggle options from the bottom bar. Press Cmd+Shift+F or Esc to exit.'
  },
  {
    icon: 'Keyboard',
  ...
  },
  {
    icon: 'GripVertical',
    title: 'Drag & Drop',
    description: 'Reorder pages, folders, and editor blocks by dragging. Move pages between folders or rearrange content within a page.'
  },
  {
    icon: 'Undo2',
