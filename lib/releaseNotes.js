export const releaseNotes = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Photos are stored once on your device instead of inside the note, so notes with photos stay small enough to sync. A device still downloading a photo shows a placeholder until it arrives.'
      },
      {
        icon: 'FileDown',
