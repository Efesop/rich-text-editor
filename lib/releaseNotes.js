export const releaseNotes = [
  {
    ...
    features: [
      {
        icon: 'LayoutTemplate',
        title: 'Cleaner desktop layout',
        description: 'The page title now sits in the document with tags, date and word count beneath it. The toolbar moved into the title bar: Lock, Self-destruct, Export, Settings and a single ⋯ menu for everything else.'
      },
      {
        icon: 'SlidersHorizontal',
        title: 'Settings in one place',
        description: 'Themes, app lock, Dash Sync, backups, trash, shortcuts and updates now live behind the settings icon in the toolbar. The sidebar groups folders and notes into sections.'
      },
      {
        icon: 'Monitor',
        title: 'Match macOS appearance',
        description: 'Pick a theme from visible swatches, or let Dash follow the system light/dark setting using your preferred dark theme.'
      },
      {
        icon: 'Table',
