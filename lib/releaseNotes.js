export const releaseNotes = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Set a secondary password that silently wipes or hides your data when entered at the lock screen.'
      }
    ]
  },
  {
...
export const featuresList = [
  ...
  },
  {
    icon: 'ShieldAlert',
    title: 'Duress Password',
    description: 'A secondary password that silently wipes or hides your data when entered at the lock screen.',
    category: 'security',
    shortcut: null,
    animation: 'duress'
  },
