 ...
 *    on all of them concurrently, preferring the primary) and caches the
...
export const PRIMARY_RELAY_URL = 'wss://sync.dashnote.io'
export const LEGACY_RELAY_URL = 'wss://dash-relay.efesop.deno.net'
/** Primary first. Same server under every name. */
export const RELAY_ALIASES = Object.freeze([PRIMARY_RELAY_URL, LEGACY_RELAY_URL])

const DEFAULT_TIMEOUT_MS = 4000
const DEFAULT_PREFER_MS = 1500
...
/**
 * Probe every candidate concurrently. The primary wins if it answers within
 * `preferMs`; otherwise the first alias to answer wins; null if none does.
 */
 ...
 * @param {number} [opts.preferMs] - how long to wait for the primary before accepting another alias
 */
